...
RSpec.describe 'Users::OmniauthCallbacks', type: :request do
  ...
  describe 'POST /users/auth/twitter/callback' do
    before do
    ...
    context 'when new user' do
      it 'returns found' do
        post user_twitter_omniauth_callback_url
        expect(response).to have_http_status(:found)
      end
      ...
      it 'increases User count' do
        expect { post user_twitter_omniauth_callback_url }.to change(User, :count).by(1)
      end
    ...
    context 'when existing confirmed user' do
      ...
      it 'does not increase User count' do
        expect { post user_twitter_omniauth_callback_url }.to change(User, :count).by(0)
      end
